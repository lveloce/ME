...
// $Id: EgammaTruthxAODHelpers.h 718563 2016-01-19 19:30:02Z christos $
...
namespace xAOD {
  ...
  namespace EgammaHelpers{
    ...
    const xAOD::TruthParticle* getBkgElectronMother(const xAOD::Electron* el,const unsigned int barcodecut=0);
    ...
    const xAOD::TruthParticle* getBkgElectronMother(const xAOD::TruthParticle* truthel, const unsigned int barcodecut=0);

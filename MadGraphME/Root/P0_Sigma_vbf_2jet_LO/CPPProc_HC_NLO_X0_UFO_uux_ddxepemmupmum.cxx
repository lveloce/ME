...
using namespace vbf_2jet_LO::HC_NLO_X0_UFO_uux_ddxepemmupmum;
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[0], w[2], pars->GC_16, pars->mdl_MW, pars->mdl_WW, w[11]); 
  FFV2_3(w[3], w[1], pars->GC_16, pars->mdl_MW, pars->mdl_WW, w[12]); 
...
double CPPProcess::matrix_uux_ddxxno_a_xz_epemmupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 3; 

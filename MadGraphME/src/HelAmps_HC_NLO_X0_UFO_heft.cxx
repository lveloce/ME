    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P2[2] = V2[1].imag(); 
  P2[3] = V2[0].imag(); 
  TMP6 = (V1[2] * P2[0] - V1[3] * P2[1] - V1[4] * P2[2] - V1[5] * P2[3]); 
  TMP20 = (P1[0] * P2[0] - P1[1] * P2[1] - P1[2] * P2[2] - P1[3] * P2[3]); 
  TMP0 = (V2[2] * P1[0] - V2[3] * P1[1] - V2[4] * P1[2] - V2[5] * P1[3]); 
  TMP2 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * S3[2] * (-cI * (TMP0 * TMP6) + cI * (TMP2 * TMP20)); 
}
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  P3[2] = -S3[1].imag(); 
  P3[3] = -S3[0].imag(); 
  TMP4 = -1. * (P1[0] * (P2[1] * (V2[4] * V1[5] - V2[5] * V1[4]) + (P2[2] *
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  int i; 
  VVS10_3(V1, V2, COUP1, M3, W3, S3); 
  VVS1_3(V1, V2, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
  ...
  VVS13_3(V1, V2, COUP4, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
    ...
    complex<double> S3[])
{
  ...
  complex<double> Stmp[3]; 
  int i; 
  complex<double> COUP4; 
  VVS10_3(V1, V2, COUP1, M3, W3, S3); 
  VVS11_3(V1, V2, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
    ...
    COUP, double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * cI * S3[2] * (P1[1] * (V2[4] * P2[3] - V2[5] * P2[2]) +
      (P1[2] * (V2[5] * P2[1] - V2[3] * P2[3]) + P1[3] * (V2[3] * P2[2] - V2[4]
      * P2[1])));
  V1[3] = denom * - cI * S3[2] * (P1[0] * (V2[5] * P2[2] - V2[4] * P2[3]) +
      (P1[2] * (V2[2] * P2[3] - V2[5] * P2[0]) + P1[3] * (V2[4] * P2[0] - V2[2]
      * P2[2])));
  V1[4] = denom * - cI * S3[2] * (P1[0] * (V2[3] * P2[3] - V2[5] * P2[1]) +
      (P1[1] * (V2[5] * P2[0] - V2[2] * P2[3]) + P1[3] * (V2[2] * P2[1] - V2[3]
      * P2[0])));
  V1[5] = denom * - cI * S3[2] * (P1[0] * (V2[4] * P2[1] - V2[3] * P2[2]) +
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  P3[2] = -V3[1].imag(); 
  P3[3] = -V3[0].imag(); 
  TMP14 = (F1[2] * (F2[4] * (P3[0] + P3[3]) + F2[5] * (P3[1] + cI * (P3[2]))) +
      F1[3] * (F2[4] * (P3[1] - cI * (P3[2])) + F2[5] * (P3[0] - P3[3])));
  TMP16 = (F1[4] * (F2[2] * (P3[0] - P3[3]) - F2[3] * (P3[1] + cI * (P3[2]))) +
      F1[5] * (F2[2] * (+cI * (P3[2]) - P3[1]) + F2[3] * (P3[0] + P3[3])));
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * - 2. * cI * (OM3 * - 1./2. * P3[0] * (TMP14 + 2. * (TMP16)) +
      (+1./2. * (F2[4] * F1[2] + F2[5] * F1[3]) + F2[2] * F1[4] + F2[3] *
      F1[5]));
  V3[3] = denom * - 2. * cI * (OM3 * - 1./2. * P3[1] * (TMP14 + 2. * (TMP16)) +
      (-1./2. * (F2[5] * F1[2] + F2[4] * F1[3]) + F2[3] * F1[4] + F2[2] *
      F1[5]));
  V3[4] = denom * 2. * cI * (OM3 * 1./2. * P3[2] * (TMP14 + 2. * (TMP16)) +
      (+1./2. * cI * (F2[5] * F1[2]) - 1./2. * cI * (F2[4] * F1[3]) - cI *
      (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
  V3[5] = denom * 2. * cI * (OM3 * 1./2. * P3[3] * (TMP14 + 2. * (TMP16)) +
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  P3[2] = -S3[1].imag(); 
  P3[3] = -S3[0].imag(); 
  TMP5 = (V2[2] * P2[0] - V2[3] * P2[1] - V2[4] * P2[2] - V2[5] * P2[3]); 
  TMP7 = (P2[0] * P2[0] - P2[1] * P2[1] - P2[2] * P2[2] - P2[3] * P2[3]); 
  TMP6 = (V1[2] * P2[0] - V1[3] * P2[1] - V1[4] * P2[2] - V1[5] * P2[3]); 
  TMP1 = (P1[0] * V1[2] - P1[1] * V1[3] - P1[2] * V1[4] - P1[3] * V1[5]); 
  TMP0 = (V2[2] * P1[0] - V2[3] * P1[1] - V2[4] * P1[2] - V2[5] * P1[3]); 
  TMP3 = (P1[0] * P1[0] - P1[1] * P1[1] - P1[2] * P1[2] - P1[3] * P1[3]); 
  TMP2 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (TMP2 * - 1. * (+cI * (TMP3 + TMP7)) + (+cI * (TMP0 * TMP1 +
      TMP5 * TMP6)));
}
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (-cI * (TMP2 * TMP20) + cI * (TMP0 * TMP6)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  P3[2] = V3[1].imag(); 
  P3[3] = V3[0].imag(); 
  TMP10 = (V1[2] * V3[2] - V1[3] * V3[3] - V1[4] * V3[4] - V1[5] * V3[5]); 
  TMP9 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  TMP8 = (P1[0] * V3[2] - P1[1] * V3[3] - P1[2] * V3[4] - P1[3] * V3[5]); 
  TMP2 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  TMP6 = (V1[2] * P2[0] - V1[3] * P2[1] - V1[4] * P2[2] - V1[5] * P2[3]); 
  TMP11 = (V2[2] * P3[0] - V2[3] * P3[1] - V2[4] * P3[2] - V2[5] * P3[3]); 
  TMP0 = (V2[2] * P1[0] - V2[3] * P1[1] - V2[4] * P1[2] - V2[5] * P1[3]); 
  TMP13 = (V1[2] * P3[0] - V1[3] * P3[1] - V1[4] * P3[2] - V1[5] * P3[3]); 
  TMP12 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
  vertex = COUP * (TMP10 * (-cI * (TMP11) + cI * (TMP0)) + (TMP12 * (-cI *
      (TMP6) + cI * (TMP13)) + TMP2 * (-cI * (TMP8) + cI * (TMP9))));
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * - cI * (F2[4] * F1[2] + F2[5] * F1[3] - P3[0] * OM3 * TMP14); 
  V3[3] = denom * - cI * (-F2[5] * F1[2] - F2[4] * F1[3] - P3[1] * OM3 *
      TMP14);
  V3[4] = denom * - cI * (-cI * (F2[5] * F1[2]) + cI * (F2[4] * F1[3]) - P3[2]
      * OM3 * TMP14);
  V3[5] = denom * - cI * (F2[5] * F1[3] - F2[4] * F1[2] - P3[3] * OM3 * TMP14); 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  denom = COUP/(pow(P1[0], 2) - pow(P1[1], 2) - pow(P1[2], 2) - pow(P1[3], 2) -
      M1 * (M1 - cI * W1));
  V1[2] = denom * S3[2] * (-cI * (TMP0 * P2[0]) + cI * (V2[2] * TMP20)); 
  V1[3] = denom * S3[2] * (-cI * (TMP0 * P2[1]) + cI * (V2[3] * TMP20)); 
  V1[4] = denom * S3[2] * (-cI * (TMP0 * P2[2]) + cI * (V2[4] * TMP20)); 
  V1[5] = denom * S3[2] * (-cI * (TMP0 * P2[3]) + cI * (V2[5] * TMP20)); 
}
    ...
    COUP1, complex<double> COUP2, double M1, double W1, complex<double> V1[])
{
  ...
  VVS10P0_1(V2, S3, COUP2, M1, W1, Vtmp); 
  i = 2; 
  while (i < 6)
  {
    V1[i] = V1[i] + Vtmp[i]; 
    ...
    complex<double> S4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  P3[2] = V3[1].imag(); 
  P3[3] = V3[0].imag(); 
  TMP17 = -1. * (P1[0] * (V1[3] * (V2[4] * V3[5] - V2[5] * V3[4]) + (V1[4] *
      ...
      V3[3]))))));
  TMP19 = -1. * (P3[0] * (V1[3] * (V2[4] * V3[5] - V2[5] * V3[4]) + (V1[4] *
      (V2[5] * V3[3] - V2[3] * V3[5]) + V1[5] * (V2[3] * V3[4] - V2[4] *
      V3[3]))) + (P3[1] * (V1[2] * (V2[5] * V3[4] - V2[4] * V3[5]) + (V1[4] *
      (V2[2] * V3[5] - V2[5] * V3[2]) + V1[5] * (V2[4] * V3[2] - V2[2] *
      V3[4]))) + (P3[2] * (V1[2] * (V2[3] * V3[5] - V2[5] * V3[3]) + (V1[3] *
      (V2[5] * V3[2] - V2[2] * V3[5]) + V1[5] * (V2[2] * V3[3] - V2[3] *
      V3[2]))) + P3[3] * (V1[2] * (V2[4] * V3[3] - V2[3] * V3[4]) + (V1[3] *
      (V2[2] * V3[4] - V2[4] * V3[2]) + V1[4] * (V2[3] * V3[2] - V2[2] *
      V3[3]))))));
  TMP18 = -1. * (P2[0] * (V1[3] * (V2[4] * V3[5] - V2[5] * V3[4]) + (V1[4] *
      (V2[5] * V3[3] - V2[3] * V3[5]) + V1[5] * (V2[3] * V3[4] - V2[4] *
      ...
      (V2[2] * V3[4] - V2[4] * V3[2]) + V1[4] * (V2[3] * V3[2] - V2[2] *
      V3[3]))))));
  vertex = COUP * - S4[2] * (+cI * (TMP17 + TMP18 + TMP19)); 
}
    ...
    complex<double> S4[], complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP13 = (V1[2] * P3[0] - V1[3] * P3[1] - V1[4] * P3[2] - V1[5] * P3[3]); 
  TMP12 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
  vertex = COUP * S4[2] * (TMP10 * (-cI * (TMP11) + cI * (TMP0)) + (TMP12 *
      (-cI * (TMP6) + cI * (TMP13)) + TMP2 * (-cI * (TMP8) + cI * (TMP9))));
}
    ...
    complex<double> & vertex)
{
  ...
  double P3[4]; 
  complex<double> tmp; 
  VVVS1_0(V1, V2, V3, S4, COUP1, vertex); 
  VVVS2_0(V1, V2, V3, S4, COUP2, tmp); 
  vertex = vertex + tmp; 
}
    ...
    double M1, double W1, complex<double> V1[])
{
  ...
  V1[2] = denom * (TMP12 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[2] * (-cI * (TMP11) + cI * (TMP0))));
  V1[3] = denom * (TMP12 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[3] * (-cI * (TMP11) + cI * (TMP0))));
  V1[4] = denom * (TMP12 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[4] * (-cI * (TMP11) + cI * (TMP0))));
  V1[5] = denom * (TMP12 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[5] * (-cI * (TMP11) + cI * (TMP0))));
}


}  // end namespace $(namespace)s_HC_NLO_X0_UFO_heft

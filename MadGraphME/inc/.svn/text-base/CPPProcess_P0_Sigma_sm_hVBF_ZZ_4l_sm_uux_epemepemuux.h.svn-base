...
#ifndef MG5_Sigma_sm_uux_epemepemuux_H
#define MG5_Sigma_sm_uux_epemepemuux_H
...
class CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux
{
  public:
    ...
    // Destructor.
    virtual ~CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux() {}
    ...
    virtual string name() const {return "u u~ > e+ e- e+ e- u u~ (sm)";}
  ...
  private:
    ...
    double matrix_uux_huux_h_zz_z_epem_z_epem(); 
...
#endif  // MG5_Sigma_sm_uux_epemepemuux_H

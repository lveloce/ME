...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[10], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  VVS3P0_1(w[9], w[8], pars->GC_13, pars->ZERO, pars->ZERO, w[17]); 
  FFV1_2(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  VVVS2P0_1(w[0], w[9], w[8], pars->GC_14, pars->ZERO, pars->ZERO, w[19]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  VVS3_0(w[11], w[12], w[8], pars->GC_13, amp[0]); 
  FFV1_0(w[1], w[14], w[13], pars->GC_11, amp[1]); 
  FFV1_0(w[15], w[10], w[13], pars->GC_11, amp[2]); 
  VVV1_0(w[13], w[9], w[12], pars->GC_10, amp[3]); 
  FFV1_0(w[1], w[16], w[17], pars->GC_11, amp[4]); 
  FFV1_0(w[18], w[10], w[17], pars->GC_11, amp[5]); 
  VVV1_0(w[0], w[17], w[12], pars->GC_10, amp[6]); 
  FFV1_0(w[1], w[10], w[19], pars->GC_11, amp[7]); 

}
double CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gu_epemmupmumgu::matrix_gu_hgu_h_epemmupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 8; 

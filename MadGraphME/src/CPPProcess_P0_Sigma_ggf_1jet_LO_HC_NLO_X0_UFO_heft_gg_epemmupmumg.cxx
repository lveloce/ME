...
#include "CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg.h"
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_x0g_no_t_xz_epemmupmum(); 
...
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVV1P0_1(w[0], w[1], pars->GC_4, pars->ZERO, pars->ZERO, w[14]); 
  ...
  VVS2_10P0_1(w[0], w[13], pars->GC_3002h, pars->GC_3002a, pars->ZERO,
      pars->ZERO, w[17]);
  VVV1P0_1(w[0], w[9], pars->GC_4, pars->ZERO, pars->ZERO, w[18]); 
  ...
  VVS2_10_0(w[9], w[14], w[8], pars->GC_3002h, pars->GC_3002a, amp[3]); 
  VVS2_10_0(w[9], w[14], w[12], pars->GC_3002h, pars->GC_3002a, amp[4]); 
  VVS2_10_0(w[9], w[14], w[13], pars->GC_3002h, pars->GC_3002a, amp[5]); 
  VVV1_0(w[1], w[9], w[15], pars->GC_4, amp[6]); 
  VVV1_0(w[1], w[9], w[16], pars->GC_4, amp[7]); 
  VVV1_0(w[1], w[9], w[17], pars->GC_4, amp[8]); 
  VVS2_10_0(w[1], w[18], w[8], pars->GC_3002h, pars->GC_3002a, amp[9]); 
  VVS2_10_0(w[1], w[18], w[12], pars->GC_3002h, pars->GC_3002a, amp[10]); 
  VVS2_10_0(w[1], w[18], w[13], pars->GC_3002h, pars->GC_3002a, amp[11]); 

}
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gg_epemmupmumg::matrix_gg_x0g_no_t_xz_epemmupmum() 
{
  int i, j; 
  // Local variables

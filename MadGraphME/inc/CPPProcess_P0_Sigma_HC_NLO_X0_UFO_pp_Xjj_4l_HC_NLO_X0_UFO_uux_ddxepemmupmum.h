...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_uux_ddxepemmupmum_H
#define MG5_Sigma_HC_NLO_X0_UFO_uux_ddxepemmupmum_H
...
class CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uux_ddxepemmupmum
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uux_ddxepemmupmum() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uux_ddxepemmupmum() {}
    ...
    virtual string name() const {return "u u~ > d d~ e+ e- mu+ mu- (HC_NLO_X0_UFO)";}
  ...
  private:
    ...
    double matrix_uux_ddxxno_a_xz_epemmupmum(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_uux_ddxepemmupmum_H

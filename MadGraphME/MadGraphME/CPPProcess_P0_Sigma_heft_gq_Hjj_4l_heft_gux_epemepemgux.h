...
#ifndef MG5_Sigma_heft_qg_Hjj_4l_gux_epemepemgux_H
#define MG5_Sigma_heft_qg_Hjj_4l_gux_epemepemgux_H
...
class CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux() {}
    ...
    virtual string name() const {return "g u~ > e+ e- e+ e- g u~ (heft)";}
  ...
  private:
    ...
    double matrix_gux_hgux_h_epemepem(); 
...
#endif  // MG5_Sigma_heft_qg_Hjj_4l_gux_epemepemgux_H

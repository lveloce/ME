...
#ifndef MG5_Sigma_sm_ddx_epemepem_H
#define MG5_Sigma_sm_ddx_epemepem_H
...
class CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemepem
{
  public:
    ...
    // Constructor.
    CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemepem() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemepem() {}
    ...
    virtual string name() const {return "d d~ > e+ e- e+ e- (sm)";}
...
#endif  // MG5_Sigma_sm_ddx_epemepem_H

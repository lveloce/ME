...
// Process: u u~ > h u u~ WEIGHTED=6
// *   Decay: h > z z WEIGHTED=2
// *     Decay: z > e+ e- WEIGHTED=2
// *     Decay: z > e+ e- WEIGHTED=2
// Process: c c~ > h c c~ WEIGHTED=6
// *   Decay: h > z z WEIGHTED=2
// *     Decay: z > e+ e- WEIGHTED=2
// *     Decay: z > e+ e- WEIGHTED=2
// Process: u u~ > h u u~ WEIGHTED=6
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_huux_h_zz_z_epem_z_epem(); 
        ...
        t[1] = matrix_uux_huux_h_zz_z_epem_z_epem(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_5_3(w[0], w[9], pars->GC_51, pars->GC_58, pars->mdl_MZ, pars->mdl_WZ,
      w[13]);
  FFV2_5_3(w[10], w[1], pars->GC_51, pars->GC_58, pars->mdl_MZ, pars->mdl_WZ,
      w[14]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  VVS1_0(w[11], w[12], w[8], pars->GC_81, amp[0]); 
  VVS1_0(w[13], w[14], w[8], pars->GC_81, amp[1]); 

}
double CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_uux_epemepemuux::matrix_uux_huux_h_zz_z_epem_z_epem() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 

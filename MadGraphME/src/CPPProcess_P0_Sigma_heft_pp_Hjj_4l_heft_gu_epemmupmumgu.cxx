...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_hgu_h_epemmupmum(); 
        ...
        t[1] = matrix_gu_hgu_h_epemmupmum(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  oxxxxx(p[perm[7]], mME[7], hel[7], +1, w[10]); 
  ...
  FFV1_2(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_1(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_0(w[1], w[17], w[16], pars->GC_11, amp[2]); 
  FFV1_0(w[1], w[17], w[18], pars->GC_11, amp[3]); 
  FFV1_0(w[19], w[10], w[16], pars->GC_11, amp[4]); 
  FFV1_0(w[19], w[10], w[18], pars->GC_11, amp[5]); 
  VVV1_0(w[16], w[9], w[12], pars->GC_10, amp[6]); 
  VVV1_0(w[18], w[9], w[12], pars->GC_10, amp[7]); 
  FFV1_0(w[1], w[20], w[21], pars->GC_11, amp[8]); 
  FFV1_0(w[1], w[20], w[22], pars->GC_11, amp[9]); 
  FFV1_0(w[23], w[10], w[21], pars->GC_11, amp[10]); 
  FFV1_0(w[23], w[10], w[22], pars->GC_11, amp[11]); 
  VVV1_0(w[0], w[21], w[12], pars->GC_10, amp[12]); 
  VVV1_0(w[0], w[22], w[12], pars->GC_10, amp[13]); 
  FFV1_0(w[1], w[10], w[24], pars->GC_11, amp[14]); 
  FFV1_0(w[1], w[10], w[25], pars->GC_11, amp[15]); 

}
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gu_epemmupmumgu::matrix_gu_hgu_h_epemmupmum() 
{
  int i, j; 
  // Local variables

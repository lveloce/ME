...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_ud_udepemepem_H
#define MG5_Sigma_HC_NLO_X0_UFO_ud_udepemepem_H
...
class CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemepem
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemepem() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemepem() {}
    ...
    virtual string name() const {return "u d > u d e+ e- e+ e- (HC_NLO_X0_UFO)";}
  ...
  private:
    ...
    double matrix_ud_udxno_a_xz_epemepem(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_ud_udepemepem_H

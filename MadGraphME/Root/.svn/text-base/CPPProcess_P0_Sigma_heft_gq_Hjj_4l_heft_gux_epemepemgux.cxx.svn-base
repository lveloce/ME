...
#include "CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux.h"
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::sigmaKin() 
{
  ...
  const int denominators[nprocesses] = {384}; 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_hgux_h_epemepem(); 
...
double CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_heft_gq_Hjj_4l_heft_gux_epemepemgux::matrix_gux_hgux_h_epemepem() 
{
  int i, j; 
  // Local variables

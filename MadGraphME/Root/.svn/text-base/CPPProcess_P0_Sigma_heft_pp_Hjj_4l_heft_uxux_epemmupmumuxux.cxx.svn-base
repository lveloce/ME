...
#include "CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux.h"
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxux_huxux_h_epemmupmum(); 
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[9], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[11]); 
  ...
  FFV1P0_3(w[9], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1P0_3(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uxux_epemmupmumuxux::matrix_uxux_huxux_h_epemmupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 4; 

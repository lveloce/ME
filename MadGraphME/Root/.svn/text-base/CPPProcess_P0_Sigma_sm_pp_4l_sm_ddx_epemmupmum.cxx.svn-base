...
// Process: d d~ > e+ e- mu+ mu- WEIGHTED=8
// Process: s s~ > e+ e- mu+ mu- WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::setM4l(double /*m_m4l*/){
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_4_1(w[3], w[11], pars->GC_50, pars->GC_59, pars->ZERO, pars->ZERO,
      w[19]);
  FFV1_2(w[0], w[7], pars->GC_1, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_2(w[0], w[14], pars->GC_1, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_0(w[20], w[1], w[14], pars->GC_1, amp[16]); 
  FFV1_0(w[21], w[1], w[7], pars->GC_1, amp[17]); 
  FFV2_3_0(w[20], w[1], w[17], pars->GC_50, pars->GC_58, amp[18]); 
  FFV1_0(w[22], w[1], w[7], pars->GC_1, amp[19]); 
  FFV1_0(w[23], w[1], w[14], pars->GC_1, amp[20]); 
  FFV2_3_0(w[21], w[1], w[10], pars->GC_50, pars->GC_58, amp[21]); 
  FFV2_3_0(w[23], w[1], w[17], pars->GC_50, pars->GC_58, amp[22]); 
  FFV2_3_0(w[22], w[1], w[10], pars->GC_50, pars->GC_58, amp[23]); 

}
double CPPProcess_P0_Sigma_sm_pp_4l_sm_ddx_epemmupmum::matrix_ddx_epemmupmum() 
{
  int i, j; 
  // Local variables

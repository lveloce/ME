...
namespace MG5_HC_NLO_X0_UFO_VH
{
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  vertex = COUP * S3[2] * (-cI * (TMP0 * TMP6) + cI * (TMP2 * TMP10)); 
}
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP6 = (V1[2] * P2[0] - V1[3] * P2[1] - V1[4] * P2[2] - V1[5] * P2[3]); 
  TMP2 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * S3[2] * (-cI * (TMP5 * TMP6) + cI * (TMP2 * TMP7)); 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * - 4. * cI * (OM3 * - 1./4. * P3[0] * (TMP8 + 4. * (TMP9)) +
      (+1./4. * (F2[4] * F1[2] + F2[5] * F1[3]) + F2[2] * F1[4] + F2[3] *
      F1[5]));
  V3[3] = denom * - 4. * cI * (OM3 * - 1./4. * P3[1] * (TMP8 + 4. * (TMP9)) +
      (-1./4. * (F2[5] * F1[2] + F2[4] * F1[3]) + F2[3] * F1[4] + F2[2] *
      F1[5]));
  V3[4] = denom * 4. * cI * (OM3 * 1./4. * P3[2] * (TMP8 + 4. * (TMP9)) +
      (+1./4. * cI * (F2[5] * F1[2]) - 1./4. * cI * (F2[4] * F1[3]) - cI *
      (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
  V3[5] = denom * 4. * cI * (OM3 * 1./4. * P3[3] * (TMP8 + 4. * (TMP9)) +
...
void VVS10_11_2_0(complex<double> V1[], complex<double> V2[], complex<double>
    ...
    complex<double> & vertex)
{
  ...
  double P2[4]; 
  complex<double> tmp; 
  VVS10_0(V1, V2, S3, COUP1, vertex); 
  VVS11_0(V1, V2, S3, COUP2, tmp); 
  vertex = vertex + tmp; 
  VVS2_0(V1, V2, S3, COUP3, tmp); 
  vertex = vertex + tmp; 
}
    ...
    complex<double> COUP4, complex<double> & vertex)
{
  ...
  complex<double> tmp; 
  VVS10_0(V1, V2, S3, COUP1, vertex); 
  VVS1_0(V1, V2, S3, COUP2, tmp); 
  vertex = vertex + tmp; 
  VVS2_0(V1, V2, S3, COUP3, tmp); 
  vertex = vertex + tmp; 
  VVS13_0(V1, V2, S3, COUP4, tmp); 
  vertex = vertex + tmp; 
}
    ...
    complex<double> & vertex)
{
  ...
  VVS1_0(V1, V2, S3, COUP2, tmp); 
  vertex = vertex + tmp; 
  VVS11_0(V1, V2, S3, COUP3, tmp); 
  vertex = vertex + tmp; 
  VVS2_0(V1, V2, S3, COUP4, tmp); 
  vertex = vertex + tmp; 
  VVS12_0(V1, V2, S3, COUP5, tmp); 
  vertex = vertex + tmp; 
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  V3[2] = denom * 2. * cI * (OM3 * 1./2. * P3[0] * (TMP8 - 2. * (TMP9)) +
      (-1./2. * (F2[4] * F1[2] + F2[5] * F1[3]) + F2[2] * F1[4] + F2[3] *
      F1[5]));
  V3[3] = denom * 2. * cI * (OM3 * 1./2. * P3[1] * (TMP8 - 2. * (TMP9)) +
      (+1./2. * (F2[5] * F1[2] + F2[4] * F1[3]) + F2[3] * F1[4] + F2[2] *
      F1[5]));
  V3[4] = denom * - 2. * cI * (OM3 * 1./2. * P3[2] * (+2. * (TMP9) - TMP8) +
      (-1./2. * cI * (F2[5] * F1[2]) + 1./2. * cI * (F2[4] * F1[3]) - cI *
      (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
  V3[5] = denom * - 2. * cI * (OM3 * 1./2. * P3[3] * (+2. * (TMP9) - TMP8) +
    ...
    double M3, double W3, complex<double> S3[])
{
  ...
  denom = COUP/(pow(P3[0], 2) - pow(P3[1], 2) - pow(P3[2], 2) - pow(P3[3], 2) -
      M3 * (M3 - cI * W3));
  S3[2] = denom * (-cI * (TMP2 * TMP10) + cI * (TMP0 * TMP6)); 
}

void VVS2_10_3(complex<double> V1[], complex<double> V2[], complex<double>
    COUP1, complex<double> COUP2, double M3, double W3, complex<double> S3[])
{
  ...
  complex<double> Stmp[3]; 
  int i; 
  VVS2_3(V1, V2, COUP1, M3, W3, S3); 
  VVS10_3(V1, V2, COUP2, M3, W3, Stmp); 
  i = 2; 
  while (i < 3)
  {
    S3[i] = S3[i] + Stmp[i]; 
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[3] = denom * - cI * (-F2[5] * F1[2] - F2[4] * F1[3] - P3[1] * OM3 * TMP8); 
    ...
    complex<double> COUP, complex<double> & vertex)
{
  ...
  TMP3 = (P1[0] * P1[0] - P1[1] * P1[1] - P1[2] * P1[2] - P1[3] * P1[3]); 
  TMP2 = (V2[2] * V1[2] - V2[3] * V1[3] - V2[4] * V1[4] - V2[5] * V1[5]); 
  vertex = COUP * S3[2] * (TMP2 * (+cI * (TMP3 + TMP7)) + (-cI * (TMP0 * TMP1 +
      TMP5 * TMP6)));
}
    ...
    double M3, double W3, complex<double> V3[])
{
  ...
  V3[3] = denom * - 2. * cI * (OM3 * - 1./2. * P3[1] * (TMP8 + 2. * (TMP9)) +
      (-1./2. * (F2[5] * F1[2] + F2[4] * F1[3]) + F2[3] * F1[4] + F2[2] *
      F1[5]));
  V3[4] = denom * 2. * cI * (OM3 * 1./2. * P3[2] * (TMP8 + 2. * (TMP9)) +
      (+1./2. * cI * (F2[5] * F1[2]) - 1./2. * cI * (F2[4] * F1[3]) - cI *
      (F2[3] * F1[4]) + cI * (F2[2] * F1[5])));
  V3[5] = denom * 2. * cI * (OM3 * 1./2. * P3[3] * (TMP8 + 2. * (TMP9)) +
      (+1./2. * (F2[4] * F1[2]) - 1./2. * (F2[5] * F1[3]) - F2[2] * F1[4] +
      F2[3] * F1[5]));
}
...
}  // end namespace $(namespace)s_HC_NLO_X0_UFO

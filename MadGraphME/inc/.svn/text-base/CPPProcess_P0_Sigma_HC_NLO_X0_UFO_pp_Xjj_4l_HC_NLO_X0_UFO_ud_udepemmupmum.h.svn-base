...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_ud_udepemmupmum_H
#define MG5_Sigma_HC_NLO_X0_UFO_ud_udepemmupmum_H
...
class CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemmupmum
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemmupmum() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_ud_udepemmupmum() {}
  ...
  private:
    ...
    double matrix_ud_udxno_a_xz_epemmupmum(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_ud_udepemmupmum_H

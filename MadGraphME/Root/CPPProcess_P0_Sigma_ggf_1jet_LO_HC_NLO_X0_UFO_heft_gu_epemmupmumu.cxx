...
#include "CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu.h"
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_x0u_no_t_xz_epemmupmum(); 
        ...
        t[1] = matrix_gu_x0u_no_t_xz_epemmupmum(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemmupmumu::matrix_gu_x0u_no_t_xz_epemmupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 3; 

...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemmupmumg_H
#define MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemmupmumg_H
...
class CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_uux_epemmupmumg
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_uux_epemmupmumg() {}
    ...
    virtual string name() const {return "u u~ > e+ e- mu+ mu- g (HC_NLO_X0_UFO_heft)";}
  ...
  private:
    ...
    double matrix_uux_x0g_no_t_xz_epemmupmum(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemmupmumg_H

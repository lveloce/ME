...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum_H
#define MG5_Sigma_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum_H
...
class CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum() {}
  ...
  private:
    ...
    double matrix_uxdx_uxdxxno_a_xz_epemmupmum(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_uxdx_uxdxepemmupmum_H

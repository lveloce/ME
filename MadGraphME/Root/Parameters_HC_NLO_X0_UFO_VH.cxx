...
Parameters_HC_NLO_X0_UFO_VH * Parameters_HC_NLO_X0_UFO_VH::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_HC_NLO_X0_UFO_VH * Parameters_HC_NLO_X0_UFO_VH::getInstance()
{
  if (instance == 0)
    instance = new Parameters_HC_NLO_X0_UFO_VH(); 

  return instance; 
}

void Parameters_HC_NLO_X0_UFO_VH::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
  ...
  mdl_cosa = slha.get_block_entry("frblock", 2, 9.000000e-01); 
...
void Parameters_HC_NLO_X0_UFO_VH::setIndependentCouplings()
{
  GC_1 = -(mdl_ee * mdl_complexi)/3.; 
  GC_2 = (2. * mdl_ee * mdl_complexi)/3.; 
  GC_3 = -(mdl_ee * mdl_complexi); 
  GC_16 = (mdl_CKM22 * mdl_ee * mdl_complexi)/(mdl_sw * mdl_sqrt__2); 
  ...
  GC_3001h = -mdl_complexi * mdl_cosa * mdl_kHaa * mdl_gHaa; 
  GC_3001a = -mdl_complexi * mdl_sina * mdl_kAaa * mdl_gAaa; 
...
void Parameters_HC_NLO_X0_UFO_VH::setDependentParameters()
{
...
void Parameters_HC_NLO_X0_UFO_VH::setDependentCouplings()
{

}
void Parameters_HC_NLO_X0_UFO_VH::set4lepMass(double m_m4l)
{
  mdl_MX0 = m_m4l;
...
long double Parameters_HC_NLO_X0_UFO_VH::setWidth(double m_m4l)
{
...
void Parameters_HC_NLO_X0_UFO_VH::printIndependentParameters()
{
  ...
  cout << setw(20) <<  "mdl_Vector_tbGp " <<  "= " <<
      setiosflags(ios::scientific) << setw(10) << mdl_Vector_tbGp << endl;
  cout << setw(20) <<  "mdl_Axial_tbGp " <<  "= " <<
      setiosflags(ios::scientific) << setw(10) << mdl_Axial_tbGp << endl;
  cout << setw(20) <<  "mdl_Vector_tbGm " <<  "= " <<
      setiosflags(ios::scientific) << setw(10) << mdl_Vector_tbGm << endl;
  cout << setw(20) <<  "mdl_Axial_tbGm " <<  "= " <<
      setiosflags(ios::scientific) << setw(10) << mdl_Axial_tbGm << endl;
...
void Parameters_HC_NLO_X0_UFO_VH::printIndependentCouplings()
{
  ...
  cout << setw(20) <<  "GC_24 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_24 << endl;
  cout << setw(20) <<  "GC_3001h " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3001h << endl;
  cout << setw(20) <<  "GC_3001a " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3001a << endl;
  cout << setw(20) <<  "GC_3005h1 " <<  "= " << setiosflags(ios::scientific) <<
  ...
  cout << setw(20) <<  "GC_3005a " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3005a << endl;
  cout << setw(20) <<  "GC_3005h2 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3005h2 << endl;
  cout << setw(20) <<  "GC_3005h3 " <<  "= " << setiosflags(ios::scientific) <<
      setw(10) << GC_3005h3 << endl;
  cout << setw(20) <<  "GC_3005h4 " <<  "= " << setiosflags(ios::scientific) <<
...
void Parameters_HC_NLO_X0_UFO_VH::printDependentParameters()
{
...
void Parameters_HC_NLO_X0_UFO_VH::printDependentCouplings()
{

...
#include "CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux.h"
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_x0ux_no_t_xz_epemepem(); 
        ...
        t[1] = matrix_gux_x0ux_no_t_xz_epemepem(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[9], w[1], w[20], pars->GC_5, amp[3]); 
  FFV1_0(w[9], w[1], w[24], pars->GC_5, amp[4]); 
  FFV1_0(w[9], w[1], w[26], pars->GC_5, amp[5]); 

}
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gux_epemepemux::matrix_gux_x0ux_no_t_xz_epemepem() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 6; 

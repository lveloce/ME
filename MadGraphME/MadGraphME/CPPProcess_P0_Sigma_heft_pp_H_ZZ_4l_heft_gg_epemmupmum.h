...
#ifndef MG5_Sigma_heft_gg_epemmupmum_H
#define MG5_Sigma_heft_gg_epemmupmum_H
...
class CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum
{
  public:
    ...
    virtual string name() const {return "g g > e+ e- mu+ mu- (heft)";}
  ...
  private:
    ...
    double matrix_gg_h_h_zz_z_epem_z_mupmum(); 
...
#endif  // MG5_Sigma_heft_gg_epemmupmum_H

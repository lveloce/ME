...
#include "CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux.h"
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[1] = matrix_gux_hgux_h_epemmupmum(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[10], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  VVS3P0_1(w[9], w[8], pars->GC_13, pars->ZERO, pars->ZERO, w[21]); 
  VVS3P0_1(w[9], w[15], pars->GC_13, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[10], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  VVVS2P0_1(w[0], w[9], w[8], pars->GC_14, pars->ZERO, pars->ZERO, w[24]); 
  VVVS2P0_1(w[0], w[9], w[15], pars->GC_14, pars->ZERO, pars->ZERO, w[25]); 
  ...
  VVV1_0(w[16], w[9], w[12], pars->GC_10, amp[6]); 
  VVV1_0(w[18], w[9], w[12], pars->GC_10, amp[7]); 
  ...
  FFV1_0(w[10], w[1], w[24], pars->GC_11, amp[14]); 
  FFV1_0(w[10], w[1], w[25], pars->GC_11, amp[15]); 

}
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_gux_epemmupmumgux::matrix_gux_hgux_h_epemmupmum() 
{
  int i, j; 
  // Local variables

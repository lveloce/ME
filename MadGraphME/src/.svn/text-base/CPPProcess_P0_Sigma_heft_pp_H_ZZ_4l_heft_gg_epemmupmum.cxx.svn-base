...
void CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_h_h_zz_z_epem_z_mupmum(); 
...
double CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_4_3(w[5], w[6], pars->GC_40, pars->GC_54, pars->mdl_MZ, pars->mdl_WZ,
      w[7]);
  VVS2_3(w[4], w[7], pars->GC_73, pars->mdl_MH, pars->mdl_WH, w[8]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  VVS3_0(w[0], w[1], w[8], pars->GC_13, amp[0]); 

}
double CPPProcess_P0_Sigma_heft_pp_H_ZZ_4l_heft_gg_epemmupmum::matrix_gg_h_h_zz_z_epem_z_mupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 1; 

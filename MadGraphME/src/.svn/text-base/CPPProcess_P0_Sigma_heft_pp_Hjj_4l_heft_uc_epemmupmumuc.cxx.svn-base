...
#include "CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc.h"
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uc_huc_h_epemmupmum(); 
        ...
        t[1] = matrix_uc_huc_h_epemmupmum(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_heft_pp_Hjj_4l_heft_uc_epemmupmumuc::matrix_uc_huc_h_epemmupmum() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 

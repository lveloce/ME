...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemepemg_H
#define MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemepemg_H
...
class CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_uux_epemepemg
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_uux_epemepemg() {}
    ...
    virtual string name() const {return "u u~ > e+ e- e+ e- g (HC_NLO_X0_UFO_heft)";}
  ...
  private:
    ...
    double matrix_uux_x0g_no_t_xz_epemepem(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_heft_uux_epemepemg_H

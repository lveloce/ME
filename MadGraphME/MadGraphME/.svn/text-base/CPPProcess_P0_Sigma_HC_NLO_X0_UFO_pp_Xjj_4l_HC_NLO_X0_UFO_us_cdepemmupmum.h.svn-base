...
#ifndef MG5_Sigma_HC_NLO_X0_UFO_us_cdepemmupmum_H
#define MG5_Sigma_HC_NLO_X0_UFO_us_cdepemmupmum_H
...
class CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_us_cdepemmupmum
{
  public:

    // Constructor.
    CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_us_cdepemmupmum() {}

    // Destructor.
    virtual ~CPPProcess_P0_Sigma_HC_NLO_X0_UFO_pp_Xjj_4l_HC_NLO_X0_UFO_us_cdepemmupmum() {}
  ...
  private:
    ...
    double matrix_us_cdxno_a_xz_epemmupmum(); 
...
#endif  // MG5_Sigma_HC_NLO_X0_UFO_us_cdepemmupmum_H

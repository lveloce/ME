...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::setM4l(double m_m4l){
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::sigmaKin() 
{
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_huux_h_zz_z_epem_z_epem(); 
        ...
        t[1] = matrix_ddx_huux_h_zz_z_epem_z_epem(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double CPPProcess_P0_Sigma_sm_hVBF_ZZ_4l_sm_ddx_epemepemuux::matrix_ddx_huux_h_zz_z_epem_z_epem() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 2; 

...
// Process: u u~ > e+ e- e+ e- WEIGHTED=8
// Process: u u~ > mu+ mu- mu+ mu- WEIGHTED=8
// Process: c c~ > e+ e- e+ e- WEIGHTED=8
// Process: c c~ > mu+ mu- mu+ mu- WEIGHTED=8

//--------------------------------------------------------------------------
// Initialize process.

void CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::setM4l(double /*m_m4l*/){
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::sigmaKin() 
{
...
double CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[0], w[22], pars->GC_2, pars->ZERO, pars->ZERO, w[25]); 
  FFV2_5_2(w[0], w[23], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[26]);
  FFV2_5_2(w[0], w[10], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[27]);
  FFV1_2(w[0], w[14], pars->GC_2, pars->ZERO, pars->ZERO, w[28]); 
  FFV1_2(w[0], w[18], pars->GC_2, pars->ZERO, pars->ZERO, w[29]); 
  FFV2_5_2(w[0], w[20], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[30]);
  FFV2_5_2(w[0], w[16], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[31]);
  ...
  FFV1_0(w[24], w[1], w[22], pars->GC_2, amp[32]); 
  FFV1_0(w[25], w[1], w[7], pars->GC_2, amp[33]); 
  FFV2_5_0(w[24], w[1], w[23], pars->GC_51, pars->GC_58, amp[34]); 
  FFV1_0(w[26], w[1], w[7], pars->GC_2, amp[35]); 
  FFV1_0(w[27], w[1], w[22], pars->GC_2, amp[36]); 
  FFV2_5_0(w[25], w[1], w[10], pars->GC_51, pars->GC_58, amp[37]); 
  FFV2_5_0(w[27], w[1], w[23], pars->GC_51, pars->GC_58, amp[38]); 
  FFV2_5_0(w[26], w[1], w[10], pars->GC_51, pars->GC_58, amp[39]); 
  FFV1_0(w[28], w[1], w[18], pars->GC_2, amp[40]); 
  FFV1_0(w[29], w[1], w[14], pars->GC_2, amp[41]); 
  FFV2_5_0(w[28], w[1], w[20], pars->GC_51, pars->GC_58, amp[42]); 
  FFV1_0(w[30], w[1], w[14], pars->GC_2, amp[43]); 
  FFV1_0(w[31], w[1], w[18], pars->GC_2, amp[44]); 
  FFV2_5_0(w[29], w[1], w[16], pars->GC_51, pars->GC_58, amp[45]); 
  FFV2_5_0(w[31], w[1], w[20], pars->GC_51, pars->GC_58, amp[46]); 
  FFV2_5_0(w[30], w[1], w[16], pars->GC_51, pars->GC_58, amp[47]); 

}
double CPPProcess_P0_Sigma_sm_pp_4l_sm_uux_epemepem::matrix_uux_epemepem() 
{
  int i, j; 
  // Local variables

...
#include "CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu.h"
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu::initProc(string param_card_name) 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu::sigmaKin() 
{
  ...
  const int denominators[nprocesses] = {384, 384}; 
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_x0u_no_t_xz_epemepem(); 
        ...
        t[1] = matrix_gu_x0u_no_t_xz_epemepem(); 
        double tsum = 0; 
...
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu::sigmaHat() 
{
...
void CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  VVS2_10P0_1(w[0], w[23], pars->GC_3002h, pars->GC_3002a, pars->ZERO,
      pars->ZERO, w[24]);
  VVS10_1_2_13_3(w[21], w[18], pars->GC_3007a, pars->GC_3007h1,
      pars->GC_3007h2, pars->GC_3007h3, pars->mdl_MX0, pars->mdl_WX0, w[25]);
  VVS2_10P0_1(w[0], w[25], pars->GC_3002h, pars->GC_3002a, pars->ZERO,
      pars->ZERO, w[26]);

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_0(w[1], w[9], w[10], pars->GC_5, amp[0]); 
  FFV1_0(w[1], w[9], w[14], pars->GC_5, amp[1]); 
  FFV1_0(w[1], w[9], w[16], pars->GC_5, amp[2]); 
  FFV1_0(w[1], w[9], w[20], pars->GC_5, amp[3]); 
  FFV1_0(w[1], w[9], w[24], pars->GC_5, amp[4]); 
  FFV1_0(w[1], w[9], w[26], pars->GC_5, amp[5]); 

}
double CPPProcess_P0_Sigma_ggf_1jet_LO_HC_NLO_X0_UFO_heft_gu_epemepemu::matrix_gu_x0u_no_t_xz_epemepem() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 6; 
